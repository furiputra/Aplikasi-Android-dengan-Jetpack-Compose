package com.rivaldo.listPlayer.ui.screen.home
...
fun HomeScreen(
    ...
    listPlayerItem: List<PlayerItem>,
    navigateToDetail: (Int) -> Unit,
    navigateToAboutMe: () -> Unit
) {
    Scaffold(
        topBar = {
            TopBarHome(title = "Players Timnas", onAboutClicked = {
                navigateToAboutMe()
            })
        },
...
fun PreviewHomeScreen() {
    CardAndroidItem(name = "Syahrul", versionNumber = "1.0", image = R.drawable.syahrul)
}